...
namespace NasokiKoide.DXSuite.Models {
    ...
    public class BadRequestErrorSorterStatus : IAdditionalDataHolder, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="BadRequestErrorSorterStatus"/> and sets the default values.
        /// </summary>
        public BadRequestErrorSorterStatus()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="BadRequestErrorSorterStatus"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static BadRequestErrorSorterStatus CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BadRequestErrorSorterStatus();
        }
        /// <summary>
