...
namespace NasokiKoide.DXSuite.Models {
    ...
    public class BadRequestErrorWorkflow : IAdditionalDataHolder, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="BadRequestErrorWorkflow"/> and sets the default values.
        /// </summary>
        public BadRequestErrorWorkflow()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="BadRequestErrorWorkflow"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static BadRequestErrorWorkflow CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BadRequestErrorWorkflow();
        }
        /// <summary>
