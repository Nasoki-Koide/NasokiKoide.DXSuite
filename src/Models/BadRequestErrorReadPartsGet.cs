...
namespace NasokiKoide.DXSuite.Models {
    ...
    public class BadRequestErrorReadPartsGet : IAdditionalDataHolder, IParsable 
...
#nullable restore
        ...
        public string Message1 { get; set; }
#endif
        /// <summary>one of unitId, pageId, dataItemId, detailDataItemId is required</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="BadRequestErrorReadPartsGet"/> and sets the default values.
        /// </summary>
        public BadRequestErrorReadPartsGet()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="BadRequestErrorReadPartsGet"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static BadRequestErrorReadPartsGet CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BadRequestErrorReadPartsGet();
        }
        /// <summary>
