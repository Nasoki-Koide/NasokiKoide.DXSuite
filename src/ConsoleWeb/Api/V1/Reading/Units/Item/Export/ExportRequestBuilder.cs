...
using System;
namespace NasokiKoide.DXSuite.ConsoleWeb.Api.V1.Reading.Units.Item.Export {
    /// <summary>
    /// Builds and executes requests for operations under \ConsoleWeb\api\v1\reading\units\{id}\export
    /// </summary>
    public class ExportRequestBuilder : BaseRequestBuilder 
    {
        ...
        public ExportRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/ConsoleWeb/api/v1/reading/units/{id}/export", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ExportRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExportRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/ConsoleWeb/api/v1/reading/units/{id}/export", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        public class ExportRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> 
        {
        }
    }
}
