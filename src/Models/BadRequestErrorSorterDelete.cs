...
namespace NasokiKoide.DXSuite.Models {
    ...
    public class BadRequestErrorSorterDelete : IAdditionalDataHolder, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="BadRequestErrorSorterDelete"/> and sets the default values.
        /// </summary>
        public BadRequestErrorSorterDelete()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="BadRequestErrorSorterDelete"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static BadRequestErrorSorterDelete CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BadRequestErrorSorterDelete();
        }
        /// <summary>
