...
namespace NasokiKoide.DXSuite.Models {
    ...
    public class BadRequestErrorReadUnitStatusGet : IAdditionalDataHolder, IParsable 
...
#nullable restore
        ...
        public string Message2 { get; set; }
#endif
        /// <summary>{0} must not contain blanks</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="BadRequestErrorReadUnitStatusGet"/> and sets the default values.
        /// </summary>
        public BadRequestErrorReadUnitStatusGet()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="BadRequestErrorReadUnitStatusGet"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static BadRequestErrorReadUnitStatusGet CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BadRequestErrorReadUnitStatusGet();
        }
        /// <summary>
