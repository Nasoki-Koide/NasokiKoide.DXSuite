...
namespace NasokiKoide.DXSuite.Models {
    ...
    public class BadRequestErrorCSVDownload : IAdditionalDataHolder, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="BadRequestErrorCSVDownload"/> and sets the default values.
        /// </summary>
        public BadRequestErrorCSVDownload()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="BadRequestErrorCSVDownload"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static BadRequestErrorCSVDownload CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BadRequestErrorCSVDownload();
        }
        /// <summary>
