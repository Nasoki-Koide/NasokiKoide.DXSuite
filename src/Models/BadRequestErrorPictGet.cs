...
namespace NasokiKoide.DXSuite.Models {
    ...
    public class BadRequestErrorPictGet : IAdditionalDataHolder, IParsable 
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="BadRequestErrorPictGet"/> and sets the default values.
        /// </summary>
        public BadRequestErrorPictGet()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="BadRequestErrorPictGet"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static BadRequestErrorPictGet CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BadRequestErrorPictGet();
        }
        /// <summary>
